...
class CommitAnalysis():
    ...
    def extract(self):
        ...
        if self._config.endDate is not None:
            endDate = datetime.strptime(self._config.endDate, "%Y-%m-%d")
        ...
        for commit in commits:
            if (startDate is not None and startDate > commit.committed_datetime) or (endDate is not None and endDate < commit.committed_datetime):
                continue
